      ...
      <section id="Education" className="education-section" style={{ backgroundColor }}>
        <div className="education-content" style={{ lineHeight: "1.2", padding: "20px" }}>
          ...
          <div className="card" style={{textAlign: "center" }}>
            <h1 style={{ color: "black", textAlign: 'center', marginBottom: "20px" }}><strong>Education</strong></h1>
            <div className="education-item" style={{ marginBottom: "10px" }}>
              <p style={{ color: "black",fontSize: '30px', fontWeight: "bold", marginBottom: "5px" }}>
            ...
            <div className="education-item">
              <p style={{ color: "black", fontSize: '30px', fontWeight: "bold", marginBottom: "5px" }}>Academic Objectives</p>
              <p style={{ color: "black", textAlign: 'center' }}>My academic objectives are to pursue a graduate degree in Computer Science with a focus on Machine Learning studies.</p>
              <p style={{ color: "black", textAlign: 'center' }}>I plan to achieve this goal after gaining practical industry skills through co-op and full-time software development/engineering positions.</p>
            </div>
          </div>
        </div>
