...
export default function Experience() {
  ...
  return (
    <section id="Experience" className="education-section">
        <h1 style={{color: "white", fontSize:"60px", marginBottom: "100px", marginLeft: "70px" }}>
        ...
        <div className="timeline">
            <div className="container left">
                <div className="content">
                  <div style ={{display: "flex"}}>
                    ...
                    <h4 style = {{fontSize: "18px", marginTop: "10px"}}><strong>Forgeahead Solutions Inc.</strong></h4>
                  </div>
                  <h2 style = {{color: "orange"}}>October 2023 - August 2024</h2>
                  <h4 style = {{fontSize: "25px"}}><strong>Machine Learning Engineer Co-op</strong></h4>
            ...
            <div className="content">
                  <div style ={{display: "flex"}}>
                    ...
                    <h4 style = {{fontSize: "18px", marginTop: "8px"}}><strong>Surge Team Orange</strong></h4>
                  </div>
                  <h2 style = {{color: "orange"}}>October 2023 - August 2024</h2>
                  <h4 style = {{fontSize: "25px"}}><strong>Technical Lead: Full-Stack Developer</strong></h4>
                    <ul className="bullet-list" style = {{marginTop: "10px"}}>
